...
carpeta=input("Carpeta de trayectoria: ")
basedyn=input("Nombre base: ")
steps=input("Steps para leer la trayectoria: ")
sample=input("Tiempo de muestreo en ps: ")

#print("Para RMSD")
print("Select system for RMSD & RMSF measurement.")
system1=input("e.g.: protein, chain X, name CA, resid 123: ")

print("Para RMSF")
print("Select system for RMSF measurement.")
system2=input("e.g.: protein, chain X, name CA, resid 123: ")
fresid=input("Numero del primer aminoácido: ")
...
############################################################
set files [glob """+carpeta+basedyn+"""*.coor.dcd]
...
f.close()
os.system("vmd -dispdev text "+carpeta+basedyn+".a.0.psf -e RMSD_RMSF.tcl")
p1 = figure()
...
show(gridplot([[p1]], plot_width=1000, plot_height=666))
...
show(gridplot([[p1]], plot_width=1000, plot_height=666))  # open a browser
